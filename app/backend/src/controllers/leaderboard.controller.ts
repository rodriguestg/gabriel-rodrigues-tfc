...
class LeaderboardController {
  ...
  getAll = async (req: Request, res: Response) => {
    const getAllMatches = await this._leaderboardService.getAll();
    return res.status(200).json(getAllMatches);
  };

  getAllHome = async (req: Request, res: Response) => {
    const getAllMatches = await this._leaderboardService.getAllHome();
    return res.status(200).json(getAllMatches);
  };

  getAllAway = async (req: Request, res: Response) => {
    const getAllMatches = await this._leaderboardService.getAllAway();
    return res.status(200).json(getAllMatches);
  };
}
